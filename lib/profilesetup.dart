...
//Class stateless สั ่งแสดงผลหนาจอ
...
//1) ประกาศตัวแปร formKey เป็ น globalkey เพื่อตรวจสอบการรับค่าที่ผู ้ใช้ป้อนผ่านฟอร์ม
  final _formKey = GlobalKey<FormState>();
//2)ประกาศตัวแปรให้ไป TextEditingController เพื่อรับที่ผู ้ป้อนผ่านฟอร์ม
  ...
  Future<void> _uploadProfile(String uid) async {
    try {
      ...
      if (_profileImage != null) {
        final storageRef =
            FirebaseStorage.instance.ref().child('profilesjirayu/$uid.jpg');
        if (kIsWeb) {
      ...
      await _dbRef.child('usersjirayu/$uid').set({
